...
namespace Code.CoreGameLogic.Pieces
{
    ...
    public class King : Piece
    {
        ...
        public King(PlayerID ownerId, IPieceMoveValidator validator, SyncVar<int> health, SyncVar<int> defensePower, SyncVar<int> attackPower, SyncVar<PlayerID> ownerID)
